...
function EpisodeInfo() {
  ...
  let singleEpisode = recentEpisodes.find((item) => {
                  ...
                  <div className="card_footer d-flex justify-content-between mt-2 mt-md-4">
                    <div className="hosters">
                      ...
                      <span className="text_first_color fw-bold">
                        {singleEpisode.hostedBy}
                      </span>
                    </div>
                  </div>

                  <div className="btn_group mt-5 d-flex gap-3">
                    <Link className="them_btn text-dark yellow_btn" to="">
                      SUBSCRIBE
                    </Link>
                    <button
                      onClick={play}
                    ...
                    >
                      <img
                        src={isPlaying ? btnPauseIcon : btnPlayIcon}
                        alt=""
                      />
                      <span className="text-white btn_text">LISTEN </span>{" "}
                      <span className="text_first_color ms-1"> ( 46 min )</span>
                    </button>
                  </div>
                </div>
              </div>
