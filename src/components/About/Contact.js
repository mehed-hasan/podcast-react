          ...
          <div className="form">
            ...
            <div className="row">
              <div className="col-12 col-md-6">
                <div className="form_group mb-4">
                  <label for="">
                    Full name <sup className="text_first_color">*</sup>
                  </label>
                  <input
                    placeholder="Name"
                ...
                <div className="form_group mb-4">
                  <label for="">
                    Email <sup className="text_first_color">*</sup>
                  </label>
                  <input
              ...
              <div className="col-12 col-md-6">
                <div className="form_group mb-4">
                  <label for="">
                    Phone <sup className="text_first_color">*</sup>
                  </label>
                  <input
                    placeholder="Phone"
                    className="form-control"
                ...
                <div className="form_group mb-4">
                  <label for="">
                    Subject <sup className="text_first_color">*</sup>
                  </label>
                  <input
                    placeholder="Subject..."
                    className="form-control"
              ...
              <div className="col-12">
                <label for="">
                  Message <sup className="text_first_color">*</sup>
                </label>
                <textarea
            ...
            <div className="submit_wrapper d-flex align-items-center justify-content-between">
              <p className="d-none d-md-block">
                required <span className="text_first_color">*</span>
              </p>
              <Link
                className="them_btn yellow_btn text-dark mt-4 mt-md-0"
                to=""
              >
                SEND MESSAGE
              </Link>
              <div className="d-none d-md-block">
                ...
                <p>
                  accumsan.{" "}
                  <Link
                    className="text_first_color text-decoration-underline"
                    to=""
                  >
                    Orci non
                  </Link>
