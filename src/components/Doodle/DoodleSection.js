        ...
        <div className="col-12 col-md-6">
          <div className="chart">
            ...
            <div className="doodle_img max-auto">
                <img  data-aos="wake-up" data-aos-duration="1200" className="img-fluid" src={DoodleImage} alt=""/>
        ...
        <div className="col-12 col-md-6">
          <div className="chart">
            ...
            <div className="doodle_img mx-auto">
                <img  data-aos="wake-up" data-aos-duration="1200" className="img-fluid" src={DoodleImage2} alt=""/>
