    ...
    return ( 
        <>
        
            {
                ...
                <Link to={'/episodes/'+data.id} key={data.id} className={`episode_wrapper ${grid}`}>
                    <div className="card card1 p-2 p-md-3 mb-3 " data-aos="fade-right" data-aos-duration="1200">
                        <div className="card_body ">
                            ...
                            <div className="col-12 col-lg-4">
                                ...
                                <img className="w-100 img-fluid" src={'../../'+data.cardThumbnail} alt=""/>
                                </div>
                            </div>
                            <div className="col-12 col-lg-8">
                                <div className="card_info">
                                <div className="card_heading d-flex flex-column justify-content-between pb-1 pb-md-3 mt-2 mt-md-0">
                                    <h5 className="text-brown fw-bold">Eps. {data.episode_no}</h5>
                            ...
                            <span className="hosters_img">
                                {
                                    ...
                                    <a key={hosters.id} href={hosters.profileLink}><img className="avatar" src={hosters.image} alt=""/></a>
                                    )
                                }
                            </span>
                        </div>
