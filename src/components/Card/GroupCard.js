        ...
        <>
            {
                ...
                <div className="card d-flex flex-column gap-5 " data-aos="fade-right" data-aos-duration="1400">
                  <div className="part1 card_heading border-0">
                    ...
                    <div className="button_and_price d-flex align-datas-center justify-content-between">
                      <Button link={"/#"} btnColors={data.id === 1? 'blue_btn text-white': data.id ===2 ? 'yellow_btn text-dark' : 'red_btn text-white'  } btnText={'Subscribe'}  />
                      <div>
                ...
                <div className="part2 card mt-4" data-aos="wake-up" data-aos-duration="1400">
                  <h6>What’s included:</h6>
                  <div className="features mt-3">
                    <ul>
                        {
                            data.features.map((features,index) =>
                                <li key={index}  className={data.id === 1? "" : data.id ===( 2 && index === 0 )|| data.id === (3 && index === 0)? "text-black fw-bold" : "" }>{data.id+features+ index}</li>
                            )
                        }
                    </ul>
                  </div>
