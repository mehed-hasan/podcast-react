        ...
        <>
            {
                ...
                <div key={data.id} className={`card2_wrapper ${grid}`}>
                    <div className="card card2 p-2 p-md-3 mb-4 mb-lg-0 " data-aos="flip-left" data-aos-duration="1200">
                        <div className="card_body ">
                            ...
                            <div className="col-12">
                                ...
                                <div className="card_heading d-flex flex-column justify-content-between pb-1 pb-md-3 mt-2 mt-md-0">
                                    <h5 className="text-uppercase mt-1 mt-md-3 fw-bold">{data.category}</h5>
                        ...
                        <div className="tag_group">
                            {  
                                data.tags.map((tag) =>
                                <BorderedBtn key={tag.id}  link={tag.taglink} btnText={tag.tagName} />
                                )
                            }
                        </div>
