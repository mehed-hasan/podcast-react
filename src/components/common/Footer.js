        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4">
              ...
              <div className="footer_socials d-flex gap-4">
                <Link to="">
                  <svg
                    width="24"
                    height="24"
                ...
                <Link to="">
                  ...
                  >
                    <path
                      d="M18.5332 6.86675C18.5332 7.63995 17.9064 8.26675 17.1332 8.26675C16.36 8.26675 15.7332 7.63995 15.7332 6.86675C15.7332 6.09355 16.36 5.46675 17.1332 5.46675C17.9064 5.46675 18.5332 6.09355 18.5332 6.86675Z"
                      fill="black"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M11.9998 16.6667C14.5772 16.6667 16.6665 14.5774 16.6665 12.0001C16.6665 9.42275 14.5772 7.33342 11.9998 7.33342C9.42251 7.33342 7.33317 9.42275 7.33317 12.0001C7.33317 14.5774 9.42251 16.6667 11.9998 16.6667ZM11.9998 14.8001C13.5462 14.8001 14.7998 13.5465 14.7998 12.0001C14.7998 10.4537 13.5462 9.20008 11.9998 9.20008C10.4534 9.20008 9.19984 10.4537 9.19984 12.0001C9.19984 13.5465 10.4534 14.8001 11.9998 14.8001Z"
                      fill="black"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M2.6665 11.6267C2.6665 8.49045 2.6665 6.92231 3.27687 5.7244C3.81376 4.67069 4.67045 3.814 5.72416 3.27711C6.92206 2.66675 8.49021 2.66675 11.6265 2.66675H12.3732C15.5095 2.66675 17.0776 2.66675 18.2755 3.27711C19.3292 3.814 20.1859 4.67069 20.7228 5.7244C21.3332 6.92231 21.3332 8.49045 21.3332 11.6267V12.3734C21.3332 15.5097 21.3332 17.0779 20.7228 18.2758C20.1859 19.3295 19.3292 20.1862 18.2755 20.7231C17.0776 21.3334 15.5095 21.3334 12.3732 21.3334H11.6265C8.49021 21.3334 6.92206 21.3334 5.72416 20.7231C4.67045 20.1862 3.81376 19.3295 3.27687 18.2758C2.6665 17.0779 2.6665 15.5097 2.6665 12.3734V11.6267ZM11.6265 4.53341H12.3732C13.9721 4.53341 15.0591 4.53487 15.8992 4.60351C16.7176 4.67037 17.1361 4.79157 17.4281 4.94032C18.1305 5.29825 18.7017 5.86938 19.0596 6.57185C19.2084 6.8638 19.3295 7.28231 19.3964 8.10069C19.4651 8.94085 19.4665 10.0278 19.4665 11.6267V12.3734C19.4665 13.9724 19.4651 15.0593 19.3964 15.8995C19.3295 16.7179 19.2084 17.1364 19.0596 17.4283C18.7017 18.1308 18.1305 18.7019 17.4281 19.0598C17.1361 19.2086 16.7176 19.3298 15.8992 19.3967C15.0591 19.4653 13.9721 19.4667 12.3732 19.4667H11.6265C10.0276 19.4667 8.94061 19.4653 8.10044 19.3967C7.28207 19.3298 6.86355 19.2086 6.57161 19.0598C5.86913 18.7019 5.29801 18.1308 4.94008 17.4283C4.79133 17.1364 4.67013 16.7179 4.60327 15.8995C4.53462 15.0593 4.53317 13.9724 4.53317 12.3734V11.6267C4.53317 10.0278 4.53462 8.94085 4.60327 8.10069C4.67013 7.28231 4.79133 6.8638 4.94008 6.57185C5.29801 5.86938 5.86913 5.29825 6.57161 4.94032C6.86355 4.79157 7.28207 4.67037 8.10044 4.60351C8.94061 4.53487 10.0276 4.53341 11.6265 4.53341Z"
                      fill="black"
                    />
                  </svg>
                </Link>
            ...
            <div className="col-lg-4">
              <div className="footer_link_wrapper d-flex justify-content-between justify-content-lg-around">
                ...
                <ul className="footer_links">
                  <li>
                    <Link to="pages/episod.html">Episodes</Link>
                  </li>
                  <li>
            ...
            <div className="col-lg-4 ">
              <div className="footer_add d-flex flex-column justify-content-end">
                <p className="text-dark">
                  Listen to episodes on your fav platform:
                </p>
                <div className="add_wrapper">
                  <Link to="https://podcasts.google.com/">
                    <img src={require("../../images/icon/Google_Podcast.png")} alt="" />
                  </Link>
                  <Link to="https://open.spotify.com/">
                    <img src={require("../../images/icon/Spotify_logo.png")} alt="" />
                  </Link>
                  <Link to="https://www.youtube.com/">
                    <img src={require("../../images/icon/Youtube_logo.png")} alt="" />
                  </Link>
                </div>
              </div>

              <div className="app_market">
                <p className="text-dark">
                  Listen to episodes on your fav platform:
                </p>

                <Link to="https://www.apple.com/app-store/">
                  <img src={require("../../images/icon/app_store.png")} alt="" />
                </Link>
                <Link to="https://play.google.com/store/">
                  <img src={require('../../images/icon/google_play.png')} alt="" />
                </Link>
              </div>
            </div>
          </div>
          <div className="gap_64"></div>
          <div className="tiny_footer d-flex justify-content-between">
            <p>
              ©2022. All Rights Reserved.{" "}
              <span className="text_first_color">Pod of Cast</span>
            </p>
            <div className="conditions">
              <ul className="d-flex">
                <li className="me-5 " style={{ listStyle: "none" }}>
                  Terms
                </li>
                <li>Privacy</li>
              </ul>
